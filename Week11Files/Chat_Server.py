...
operation:
    ...
    Handles the receiving of messages on client-->server socket. On startup of
    each new client, the server reads the clients public key and generate a unique
    session key to be used with that specific client.
